...
public class Controller {
    ...
    public ResponseEntity<ExchangeResponse> exchange(@RequestParam(value = EXCHANGE_PARAM_FROM) String from,
        ...
        BigDecimal exchange = toRates.rate.divide(fromRates.rate, EXCHANGE_SCALE, RoundingMode.HALF_UP).multiply(BigDecimal.ONE.subtract(spread.spread)).stripTrailingZeros();
